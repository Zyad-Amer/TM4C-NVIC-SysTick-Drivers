...
#define NVIC_PRI_REG(irq_num) (*((volatile uint32 *)(0xE000E400 + ((irq_num / 4) * sizeof(uint32)))))
...
void NVIC_EnableException(NVIC_ExceptionType Exception_Num)
{
    switch (Exception_Num)
    {
        case EXCEPTION_MEM_FAULT_TYPE:
            SET_BIT(NVIC_SYSTEM_SYSHNDCTRL, 18); /* Enable the memory management fault */
            break;
        ...
        case EXCEPTION_USAGE_FAULT_TYPE:
            SET_BIT(NVIC_SYSTEM_SYSHNDCTRL, 16); /* Enable the Usage fault */
            break;
...
void NVIC_DisableException(NVIC_ExceptionType Exception_Num)
{
    ...
    {
        case EXCEPTION_MEM_FAULT_TYPE:
            CLEAR_BIT(NVIC_SYSTEM_SYSHNDCTRL, 18); /* Disable the memory management fault */
            break;
        ...
        case EXCEPTION_USAGE_FAULT_TYPE:
            CLEAR_BIT(NVIC_SYSTEM_SYSHNDCTRL, 16); /* Disable the Usage fault */
            break;
